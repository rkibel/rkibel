      ...
      return (
        ...
        <div className="flex items-start gap-8">
          ...
          <div className="flex-1">
            <strong className="block font-medium text-gray-900"> Email sent successfully</strong>

            <p className="mt-1 text-sm text-gray-700">Thank you for messaging!</p>
          </div>
        ...
        <div className="flex items-start gap-4">
          <div className="flex-1">
            ...
            <p className="mt-2 text-sm text-red-700">
              The server seems to be down, please email me directly for any questions!
            </p>
          </div>
